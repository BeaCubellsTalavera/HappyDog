...
- [ ] Crear doc `config/nfc` en Firestore con `token: <UUID random>`
...
- [ ] **[Manual usuario]** Grabar pegatina NFC con app "NFC Tools" (Android) o "NFC TagWriter by NXP" (iPhone) con URL `https://<app>.vercel.app/feed?token=<UUID>`
